...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-secondary-500 data-[state=selected]:bg-secondary-500 dark:hover:bg-secondary-500 dark:data-[state=selected]:bg-secondary-500",
      className
    )}
    {...props}
  />
